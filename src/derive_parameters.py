# src/derive_parameters.py
# GRCH: S0 and tau derivation - CORRECTED VERSION
# Matches paper: S0 = 0.95

import sympy as sp

# Decoherence fraction: f_decoh = exp(-Gamma * t_reheat)
# We set Gamma so that S0 = 0.95 at T_RH = 1e9 GeV
T_RH_val = 1e9
f_decoh_target = 0.05  # Because S0 = 1 - f_decoh = 0.95
